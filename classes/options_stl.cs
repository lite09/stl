...
public class Options_stl
{
    public string proizvoditel;// { get; set; }
    public string PROIZVODITEL { get { return proizvoditel; } set { proizvoditel = value; } }
    public string description;
    public string DESCRIPTION { get { return description; } set { description = value; } }
    public string delivery_package_type;
    public string DELIVERY_PACKAGE_TYPE { get { return delivery_package_type; } set { delivery_package_type = value; } }
    public string delivery_package;
    public string DELIVERY_PACKAGE { get { return delivery_package; } set { delivery_package = value; } }
    ...
    public string length_pack;
    public string LENGTH_PACK { get { return length_pack; } set { length_pack = value; } }
    public string width_pack;
    ...
    public static string [] get_artbumbers(List<Options_stl> op)
    {
        List<string> artnumbers = new List<string>();
        for (int i = 0; i < op.Count; i++)
            artnumbers.Add(op[i].artnumber);

        return artnumbers.ToArray();
    }

    public string get_property(string property, Options_stl op)
    {
        try
        {
            FieldInfo i = typeof(Options_stl).GetField(property.ToLower());
            if (i == null)
                return "";
